...
def main() -> int:
    ...
    parser.add_argument("--python", action="append", default=[], help="Python project directory to check")
    parser.add_argument("--node", action="append", default=[], help="Node project directory to check")
    parser.add_argument("--write-notice", action="store_true", help="Generate and update NOTICE file")
